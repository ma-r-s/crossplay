...
truth table, `src/apps_local/go/GoPatterns.h`, generated by
`tools_local/go/gen_go_patterns.py`. The compact nine-position-class encoding is
[ArduGO](https://github.com/jaychan/ardu_go)'s (MIT, Copyright (c) 2026 Jay
Chan), whose independently compiled table this one is checked against byte for
byte. Full text at `assets_local/go/LICENSE-ardugo`, with the derivation in
`assets_local/go/README.md`.
