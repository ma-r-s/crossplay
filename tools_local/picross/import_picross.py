...
def main():
    ...
    with open(out, "w", encoding="utf-8") as handle:
        handle.write(
            (PERMITTED_BANNER if permitted else BANNER)
            % {
                # An evaluation file stays outside the tree and the full path is
                # the useful thing; a committed one records the corpus's name.
                "corpus": os.path.basename(args.corpus) if permitted else args.corpus,
