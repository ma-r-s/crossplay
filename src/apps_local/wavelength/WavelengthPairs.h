...
inline constexpr Pair kPairsEn[] = {
    ...
    {"USEFUL", "USELESS"},
    {"MOVIE THAT GODZILLA WOULD IMPROVE", "MOVIE THAT GODZILLA WOULD RUIN"},
    ...
    {"CLASSIC", "FAD"},
    {"STRONG", "WEAK"},
    {"DELICIOUS CEREAL", "DISGUSTING CEREAL"},
    ...
    {"FIRM", "LIMP"},
    {"ACTUALLY JUST BAD", "GUILTY PLEASURE"},
    {"NEWS", "GOSSIP"},
    ...
    {"FRINGE BELIEF", "CONVENTIONAL WISDOM"},
    ...
    {"REASONABLE PHOBIA", "UNREASONABLE PHOBIA"},
