...
constexpr Terrain buildTropicalPool() {
  ...
  const uint16_t xs[17] = {500, 500, 982, 964, 500, 18, 18, 36, 982, 982, 500, 18, 500, 18, 982, 18, 982};
  const uint16_t ys[17] = {3, 205, 205, 396, 500, 410, 205, 604, 590, 795, 795, 795, 997, 997, 997, 3, 3};
  for (int i = 0; i < 17; ++i) {
    t.x[i] = xs[i];
    t.y[i] = ys[i];
  }
  ...
  const R regions[] = {
      ...
      {(1u << 10) | (1u << 11) | (1u << 12), 1, 420, 876},
      {(1u << 4) | (1u << 9) | (1u << 10), 1, 605, 689},
      {(1u << 1) | (1u << 4) | (1u << 6), 1, 395, 311},
      {(1u << 1) | (1u << 2) | (1u << 3) | (1u << 4), 2, 638, 336},
      {(1u << 4) | (1u << 7) | (1u << 10) | (1u << 11), 2, 362, 664},
