...
constexpr Terrain buildCastleField() {
  ...
  const uint16_t ys[17] = {10, 10, 182, 182, 500, 500, 500, 818, 818, 990, 990, 269, 731, 731, 269, 1000, 0};
  for (int i = 0; i < 17; ++i) {
    t.x[i] = xs[i];
    t.y[i] = ys[i];
  }
  ...
  const R regions[] = {
      {(1u << 6) | (1u << 7) | (1u << 13), 1, 880, 675},
      {(1u << 4) | (1u << 8) | (1u << 12), 1, 120, 675},
      {(1u << 5) | (1u << 7) | (1u << 8) | (1u << 9) | (1u << 10), 3, 500, 840},
      {(1u << 0) | (1u << 1) | (1u << 2) | (1u << 3) | (1u << 5), 3, 500, 160},
      {(1u << 3) | (1u << 4) | (1u << 11), 1, 120, 325},
      {(1u << 2) | (1u << 6) | (1u << 14), 1, 880, 325},
      {(1u << 4) | (1u << 5), 2, 300, 500},
      {(1u << 5) | (1u << 6), 2, 700, 500},
  };
